 ...
 */
public class SentenceFragment extends SelectableFragment implements View.OnTouchListener {
    @Override
    public void onResume() {
        super.onResume();
        ((MainActivity) getActivity()).getToolbar().setTitle(R.string.nav_drawer_sentence);
    }
